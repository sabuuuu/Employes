 ...
 * @author Sabu
 */
public class CorrespondantHome extends javax.swing.JFrame {

    public CorrespondantHome() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("DzVues - Correspondant home");

        jPanel1.setBackground(new java.awt.Color(227, 202, 171));

        jLabel2.setFont(new java.awt.Font("Century Gothic", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(20, 49, 9));
        jLabel2.setText("Ajouter un nouvel article");
        jLabel2.setToolTipText("");

        jButton1.setBackground(new java.awt.Color(20, 49, 9));
        jButton1.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        jButton1.setForeground(new java.awt.Color(227, 202, 171));
        ...
        jLabel7.setText("numéro de revue");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CorrespondantHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CorrespondantHome().setVisible(true);
            }
        });
    }
